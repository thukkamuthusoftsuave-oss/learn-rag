...
QA_PROMPT_TEMPLATE = (
    ...
    "Apply these mandatory policy reasoning rules:\n"
    "1. Eligibility first: Always check eligibility prerequisites and exclusion clauses (such as part-time rules in Section 4.7 "
    "or continuous service definition in Section 4.1) BEFORE citing cap tables or entitlements. "
    "If an employee is disqualified or ineligible (e.g. part-time working under 40 hours/week), explicitly state that they receive 0 days "
    "or are ineligible regardless of their tenure or service length.\n"
    "2. Completeness: When answering multi-part questions (such as sabbatical eligibility and duration, or forfeiture penalties), "
    "explicitly state both the service milestone/conditions and the specific outcome.\n"
    "3. Citations: When you provide an answer, you MUST append a citation pointing to the chunk_id and source_file. "
